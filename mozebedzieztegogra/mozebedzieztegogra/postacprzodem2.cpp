...
void DrawJumpFrame2(SDL_Renderer* renderer) {
    ...
    //kopniete prostokaty
    DrawRotatedRect(renderer, 280, 340, 160, 20, 180, bodycolor); //reka lewa
    DrawRotatedRect(renderer, 337, 320, 150, 20, 0, bodycolor); //reka prawa
    ...
    DrawFilledRectangle(renderer, 250, 520, 100, 160, legscolor); //spodnie
    DrawFilledRectangle(renderer, 240, 680, 120, 50, shoescolor); //buty
    ...
    */
    ...
    DrawFilledRectangle(renderer, 230, 148, 20, 3, eyescolor2); //oko zamkkniete
    DrawFilledRectangle(renderer, 350, 148, 20, 3, eyescolor2); //oko zamkkniete
