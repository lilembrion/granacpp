...
void DrawJumpFrame3(SDL_Renderer* renderer) {
    ...
    //kopniete prostokaty
    DrawRotatedRect(renderer, 270, 340, 160, 20, 210, bodycolor); //reka lewa
    DrawRotatedRect(renderer, 320, 320, 160, 20, -30, bodycolor); //reka prawa
    ...
    DrawFilledRectangle(renderer, 250, 520, 100, 140, legscolor); //spodnie
    DrawFilledRectangle(renderer, 240, 660, 120, 50, shoescolor); //buty
